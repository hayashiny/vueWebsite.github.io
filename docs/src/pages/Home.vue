<template>
  <div id="vueLink">
    <div id="titleClass" class="titleClass">
            <h1 id="title">Hayashi <br>Japanese Fusion</h1>
            <p id="slogan">Enjoy The East</p>
        </div>
        <div class="bannerIMG"></div>
        <h1 id="name">Hayashi</h1>
        <div class="nav">
...
body{
    background:url("/src/assets/ForWebsite/background.png");
    margin:0px;
    overflow:hidden;
}

.bannerIMG{
    background-image:url("/src/assets/ForWebsite/sushi banner image cropped.png");
...
@font-face{
    font-family:AvantGarde;
    src:url('/src/assets/ForWebsite/AvantGardeGothicLight.woff');
}
...
@media screen 
  ...
  and (-webkit-min-device-pixel-ratio: 2) { 
    ...
    .align-right.slideIn{
        transform:translate(40%,-25%) scale(0.95);
    }
